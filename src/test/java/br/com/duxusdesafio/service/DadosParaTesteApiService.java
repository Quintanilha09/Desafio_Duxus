...
public class DadosParaTesteApiService {
    ...
    public List<String> getNomesChicagoBullsDe1995() {
        List<String> nomes = new ArrayList<>();
        nomes.add(michael_jordan.getNome());
        nomes.add(denis_rodman.getNome());
        nomes.add(scottie_pippen.getNome());
        return nomes;
    }

    public List<String> getNomesDetroidPistonsDe1993() {
        List<String> nomes = new ArrayList<>();
        nomes.add(denis_rodman.getNome());
        return nomes;
    }
