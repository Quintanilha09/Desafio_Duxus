...
public class TesteApiService {
    ...
    public static Object[][] testTimeDaDataParams() {
        ...
        List<String> nomesChicagoBullsDe1995 = dadosParaTesteApiService.getNomesChicagoBullsDe1995();
        List<String> nomesDetroidPistonsDe1993 = dadosParaTesteApiService.getNomesDetroidPistonsDe1993();
        ...
        return new Object[][]{
                {
                        data1995,
                        todosOsTimes,
                        nomesChicagoBullsDe1995
                },
                {
                        data1993,
                        todosOsTimes,
                        nomesDetroidPistonsDe1993
                }
        };
    }
    ...
    public void testTimeDaData(LocalDate data, List<Time> todosOsTimes, List<String> esperado) {

        List<String> nomesRetornados = apiService.timeDaData(data, todosOsTimes);

        assertEquals(esperado, nomesRetornados);
    }
